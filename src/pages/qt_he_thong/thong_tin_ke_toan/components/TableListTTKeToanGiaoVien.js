...
import { GetTTKeToanGiaoVienRequest, deleteTTKeToanRequest } from '../../../../reducers/quan-tri/TTKeToan/TTKeToanAction';
import { get as _get } from 'lodash';


/**                                                                                                                                                       
 * List TTKeToanGiaoVien                                                                                                                                
 * @param {*} props                                                                                                                                       
 * @returns                                                                                                                                               
 */
export default function TableListTTKeToanGiaoVien() {
  const history = useHistory();
  const dispatch = useDispatch();

  // listen data of grid                                                                                                                                  
  const rows = useSelector((state) => _get(state, "thongTinKTGVs.thongTinKTGVs", []));
  /**
   * confirm delete item
   * @param {*} id 
   */
 ...
 */
  ...
  return (
    <div>
      <MaterialTable 
        title="Thông tin kế toán cho giáo viên"
        columns={columns}
        data={data}
