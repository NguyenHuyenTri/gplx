...
import { getKhoaHocRequest, } from '../../../../reducers/DTHVState/DTHVAction';
import { getDiemThiByIdRequest } from '../../../../reducers/dao-tao/DiemThi/DiemThiAction'
...
export default function CustomizedInputBase() {
  ...
  useEffect(() => {
    ...
    if (Array.isArray(khoaHocs) && khoaHocs.length > 0) {
      ...
      dispatch(getDiemThiByIdRequest(khoaHocs[0].id));
    }
  }, [dataKhoaHoc]);

  const handleChange = (e) => {
    dispatch(getDiemThiByIdRequest(e.target.value));
  };
  ...
  return (
    <div className={classes.container}>
      ...
      <div>
        <Link to={'/hoc_vien/them_hoc_vien'} className={classes.link}>
