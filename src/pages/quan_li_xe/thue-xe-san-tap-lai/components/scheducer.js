...
import { convertData } from './appointments';
...
class AppointmentFormContainerBasic extends React.PureComponent {
  ...
  render() {
    const { classes, visible, visibleChange, appointmentData, cancelAppointment, target, onHide } =
      this.props;
    const { appointmentChanges } = this.state;
...
class Demo extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      data: convertData(this.props.lichThueXes),
      currentDate: new Date(this.props.lichThueXes[0].ngayGioBDThue),
